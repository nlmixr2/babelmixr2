...
if (file.exists("pk.turnover.emax3-nonmem/pk.turnover.emax3-rounding.qs2")) {
  unlink("pk.turnover.emax3-nonmem/pk.turnover.emax3-rounding.qs2")
}
if (file.exists("pk.turnover.emax4-nonmem/pk.turnover.emax4.qs2")) {
  unlink("pk.turnover.emax4-nonmem/pk.turnover.emax4.qs2")
}
```
