...
rxUiGet.popedSettings <- function(x, ...) {
  ...
  list(settings=list(
    ...
    EANumPoints=rxode2::rxGetControl(ui, "ts", FALSE),
    EAConvergenceCriteria=rxode2::rxGetControl(ui, "ceCriteria", 1e-20),
    bEANoReplicates=rxode2::rxGetControl(ui, "oReplicates", FALSE),
    BFGSProjectedGradientTol=rxode2::rxGetControl(ui, "tTol", 1e-04),
    BFGSTolerancef=rxode2::rxGetControl(ui, "cef", 0.001),
    BFGSToleranceg=rxode2::rxGetControl(ui, "ceg", 0.9),
    BFGSTolerancex=rxode2::rxGetControl(ui, "cex", 0.1),
    ED_diff_it=rxode2::rxGetControl(ui, "ED_diff_it", 30),
    ED_diff_percent=rxode2::rxGetControl(ui, "t", 10),
    line_search_it=rxode2::rxGetControl(ui, "e_search_it", 50),
    ...
    MCC_Dep=rxode2::rxGetControl(ui, "MCC_Dep", NULL),
    strExecuteName=rxode2::rxGetControl(ui, "ame", "calc_fim.exe"),
    iNumProcesses=rxode2::rxGetControl(ui, "umProcesses", 2),
    iNumChunkDesignEvals=rxode2::rxGetControl(ui, "Evals", -2),
    Mat_Out_Pre=rxode2::rxGetControl(ui, "Mat_Out_Pre", "parallel_output"),
    strExtraRunOptions=rxode2::rxGetControl(ui, "s", ""),
    dPollResultTime=rxode2::rxGetControl(ui, "dPollResultTime", 0.1),
    strFunctionInputName=rxode2::rxGetControl(ui, "ame", "function_input"),
